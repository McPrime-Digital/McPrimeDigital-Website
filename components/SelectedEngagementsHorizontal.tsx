...
export default function SelectedEngagementsHorizontal() {
    ...
    return (
        <section className="py-24 sm:py-32 relative bg-[#050505] overflow-hidden rounded-3xl border border-white/5 my-12">
            <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[80%] h-[1px] bg-gradient-to-r from-transparent via-cyan-500/30 to-transparent" />
            ...
            <div className="relative w-full flex overflow-hidden group">
                ...
                >
                    {doubledEngagements.map((item, index) => (
                        <div
                            key={index}
                            className="w-[350px] md:w-[450px] flex-shrink-0 group/card relative rounded-2xl border border-white/10 bg-[#0a0a0a]/80 backdrop-blur-xl p-8 hover:bg-[#111] transition-all duration-500 hover:border-white/20 hover:shadow-[0_0_40px_rgba(0,0,0,0.6)] overflow-hidden flex flex-col"
                        >
                            {/* Card Hover Glow */}
