...
// Custom SVGs for brand icons not in lucide-react
        ...
        >
            ...
            <div className="px-2">
                ...
                <div className="flex gap-4">
                    <SocialLink icon={TikTokIcon} href={person.socials.tiktok} label="TikTok" />
                    ...
                    <SocialLink icon={XIcon} href={person.socials.twitter} label="X" />
                    <SocialLink icon={Linkedin} href={person.socials.linkedin ?? "#"} label="LinkedIn" />
                </div>
            </div>
        </motion.div>
    );
